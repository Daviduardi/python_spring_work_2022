...
class Profile:
    def __init__(self, id_group, surname, name, patronityc, age, login, phone, e_mail, password):
...
conn = connection.get_connect()
new_student = Profile(1, 'Stepanyan', 'Gevorg', 'Karoevich', 27, 'Gevo', 333444, '1234')
